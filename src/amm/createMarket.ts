import { RAYMint, SOLMint, OPEN_BOOK_PROGRAM, DEVNET_PROGRAM_ID, WSOLMint } from '@raydium-io/raydium-sdk-v2'
...
export const createMarket = async () => {
  ...
  const { execute, extInfo, transactions } = await raydium.marketV2.create({
    baseInfo: {
      mint: new PublicKey('7QN7Bq8Hh9cU5UZdQ4n2AWvuxFeeXr7aGgvQNG9ERZJC'),
      decimals: 6,
    },
    quoteInfo: {
      mint: SOLMint,
